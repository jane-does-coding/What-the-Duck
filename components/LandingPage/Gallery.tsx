...
const Gallery = () => {
	...
	const items = [
		{
			color: "bg-red-200/70",
			main: "/screenshots/ss1.png",
			label: "Sprint Monte Carlo",
			extras: [
		...
		},
		{
			...
			main: "/screenshots/ss2.png",
			label: "Advices & Recommendations",
			extras: [
		...
		},
		{
			...
			main: "/screenshots/ss3.png",
			label: "Anti-Practices Detection",
			extras: [
	...
	return (
		<div className="h-[55vw] pt-[6vw] mt-[4vh] mb-[4vh] w-full flex items-start justify-center overflow-hidden relative bg-red-200/0">
			{/* Carousel track */}
			<motion.div
				className="flex items-center justify-center gap-[0vw] pl-[100vw] pt-[1vh]"
